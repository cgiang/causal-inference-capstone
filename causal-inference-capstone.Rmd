...
```{r}
mod12 <- lm(SPOUSEPRES~caring_HH_adults, data = data)
summary(mod12)

mod13 <- lm(SPOUSEPRES~Traveling, data = data)
summary(mod13)

mod14 <- lm(SPOUSEPRES~SPEMPSTAT, data = data)
summary(mod14)

mod15 <- lm(SPEDUC~SPEMPSTAT, data = data)
summary(mod15)
```
